        ...
        <>
            <form className="w-full lg:flex  lg:items-end lg:justify-between pt-10 pb-5 lg:pt-15 lg:pb-8  md:gap-4 xl:pt-20 xl:pb-10" onSubmit={submitForm}>
                ...
                <div className="lg:w-4/10">
                    ...
                    <input type="text" ref={desRef} className="focus:outline-2 focus:outline-[#00B84F] focus:drop-shadow-[#00a51A]/30 focus:drop-shadow-xl/25 bg-white rounded-md w-full text-md md:text-xl py-2 px-3 xl:py-3 xl:px-4 xl:text-2xl" placeholder="Description of your To-Do ?"/>
                </div>
                <div className="pt-8">
